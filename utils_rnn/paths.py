...
class Paths :
    def __init__(self, data_path, model_id) :
        self.data = data_path
        self.quant = f'{data_path}/quant_fmax_8000/'
        self.mel = f'{data_path}/mel_fmax_8000/'
        self.checkpoints = f'checkpoints/{model_id}/'
        #self.latest_weights = f'{self.checkpoints}latest_weights.pyt'
        self.latest_weights = f'/data/wangtao/wavernn/WaveRNN/checkpoints/8bit_mulaw/checkpoint_225k_steps.pyt'
